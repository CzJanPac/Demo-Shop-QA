...
| **6. Odeslání a potvrzení** | • Integrační (API + DB)<br>• Systémové (UI) | • Chybové odhadování (*Error Guessing*) | Zápis do DB, vyprázdnění košíku, odečet ze skladu). Error Guessing pro prevenci duplicity (double-click). |
